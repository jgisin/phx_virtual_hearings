...
defmodule VirtualHearingsWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: VirtualHearingsWeb.Coherence.EmailView, layout: {VirtualHearingsWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
